...
class BodySkeleton: Entity {
    ...
    private func createSkeletonBone(bone:Bones, bodyAnchor:ARBodyAnchor) -> SkeletonBone? {
        ...
        let jointFromEntityOffsetFromRoot = simd_make_float3(fromJointEntityTransform.transform.columns.3)
        ...
        let jointToEntityOffsetFromRoot = simd_make_float3(toJointEntityTransform.transform.columns.3)
